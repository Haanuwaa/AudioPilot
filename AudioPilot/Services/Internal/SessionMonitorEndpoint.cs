...
namespace AudioPilot.Services.Internal
{
    ...
    internal sealed class CoreAudioSessionMonitorEndpoint : ISessionMonitorEndpoint
    {
        ...
        /// <summary>
        /// Takes ownership of the device immediately and releases all acquired resources if initialization fails.
        /// Callers must not dispose the device again after a failed construction.
        /// </summary>
