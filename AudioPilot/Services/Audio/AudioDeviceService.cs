...
namespace AudioPilot.Services.Audio
{
    ...
    public partial class AudioDeviceService : IAudioDeviceEnumerator, IDisposable, IAsyncDisposable
    {
        ...
        internal event Action? DefaultMicrophoneRolesChanged;
        ...
        internal bool AwaitPostSwitchCompletion { get; set; }
        ...
        private readonly Func<CancellationToken, Task> _waitForSessionInitializationAsync;
        ...
        internal AudioDeviceService(
            ...
            Func<CancellationToken, Task>? waitForSessionInitializationAsync = null)
        {
            ...
            _waitForSessionInitializationAsync = waitForSessionInitializationAsync
        ...
        internal void InvalidateRecentMixerSnapshotState(bool refreshProcessMetadata = false)
        {
            if (refreshProcessMetadata)
            {
                _sessionService.ClearCaches();
            }
            else
            {
        ...
        {
            return _endpointQueryHelper.TryGetDeviceById(deviceId, DataFlow.Render);
        }

        public MMDevice? TryGetCaptureDeviceById(string deviceId)
        {
            return _endpointQueryHelper.TryGetDeviceById(deviceId, DataFlow.Capture);
        }

        /// <summary>
        /// Stops background audio work and releases device, session, and notification resources.
        /// </summary>
        ...
        private void DisposeFinalResources()
        {
            ...
            _enumeratorLock.EnterWriteLock();
            try
            {
