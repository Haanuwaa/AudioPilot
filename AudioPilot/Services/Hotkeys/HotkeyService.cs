...
namespace AudioPilot.Services.Hotkeys
{
    ...
    public partial class HotkeyService : IDisposable
    {
        ...
        public bool RegisterToggleAppVisibilityHotkey(string? toggleAppVisibilityHotkey, IEnumerable<string>? additionalStandaloneHotkeyKeys = null)
        {
        ...
        public bool RegisterShowAudioStatusHotkey(string? hotkey, IEnumerable<string>? additionalStandaloneHotkeyKeys = null)
        {
            bool registered = RegisterGenericHotkey(
        ...
        public bool RegisterMediaHotkeys(string? showCurrent, string? playPause, string? next, string? prev, IEnumerable<string>? additionalStandaloneHotkeyKeys = null, string? seekForward = null, string? seekBackward = null)
        {
            ...
            bool playPauseRegistered = RegisterGenericHotkey(AppConstants.Hotkeys.MediaPlayPauseId, playPause, null, () => OnMediaPlayPausePressed?.Invoke(), "Play/Pause", options, additionalStandaloneHotkeyKeys);
            bool nextRegistered = RegisterGenericHotkey(AppConstants.Hotkeys.MediaNextTrackId, next, null, () => OnMediaNextTrackPressed?.Invoke(), "Next Track", options, additionalStandaloneHotkeyKeys);
            bool prevRegistered = RegisterGenericHotkey(AppConstants.Hotkeys.MediaPrevTrackId, prev, null, () => OnMediaPrevTrackPressed?.Invoke(), "Prev Track", options, additionalStandaloneHotkeyKeys);
            bool forwardRegistered = RegisterGenericHotkey(AppConstants.Hotkeys.MediaSeekForwardId, seekForward, null, () => OnMediaSeekForwardPressed?.Invoke(), "Seek Forward", options, additionalStandaloneHotkeyKeys);
            bool backwardRegistered = RegisterGenericHotkey(AppConstants.Hotkeys.MediaSeekBackwardId, seekBackward, null, () => OnMediaSeekBackwardPressed?.Invoke(), "Seek Backward", options, additionalStandaloneHotkeyKeys);
            FinalizeKeyboardMessageHostLifecycle();
        ...
        public void UnregisterAllHotkeys()
        {
            lock (_lock)
            {
                foreach (HotkeyDefinition definition in _hotkeys) definition.IsActive = false;
