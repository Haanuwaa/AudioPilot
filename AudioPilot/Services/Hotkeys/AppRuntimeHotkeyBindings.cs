...
{
    internal sealed class AppRuntimeHotkeyBindings(
        HotkeyService hotkeyService,
        Action onToggleAppVisibility,
        Action onShowAudioStatus,
        Action onMediaShowCurrentTrack,
        Action onMediaPlayPause,
        Action onMediaNextTrack,
        Action onMediaPreviousTrack,
        Action onMediaSeekForward,
        Action onMediaSeekBackward,
        Action onMuteMic,
        Action onMuteSound,
        Action onDeafen,
        ...
        Action? onForegroundVolumeUp = null,
        Action? onForegroundVolumeDown = null,
        Action? onForegroundMute = null,
        Action<bool, Func<bool>>? onMicrophoneHold = null,
        Action? onMicrophoneHoldCancelled = null)
    {
        private readonly HotkeyService _hotkeyService = hotkeyService;
        private readonly Action _onToggleAppVisibility = onToggleAppVisibility;
        private readonly Action _onShowAudioStatus = onShowAudioStatus;
        ...
        private readonly Action _onMediaSeekForward = onMediaSeekForward;
        private readonly Action _onMediaSeekBackward = onMediaSeekBackward;
        ...
        public void Wire()
        {
            ...
            _hotkeyService.OnToggleAppVisibilityHotkeyPressed += _onToggleAppVisibility;
            _hotkeyService.OnShowAudioStatusPressed += _onShowAudioStatus;
            ...
            _hotkeyService.OnMediaSeekForwardPressed += _onMediaSeekForward;
            _hotkeyService.OnMediaSeekBackwardPressed += _onMediaSeekBackward;
            ...
            _hotkeyService.OnForegroundVolumeUpPressed += onForegroundVolumeUp;
            _hotkeyService.OnForegroundVolumeDownPressed += onForegroundVolumeDown;
            _hotkeyService.OnForegroundMutePressed += onForegroundMute;
            _hotkeyService.OnMicrophoneHoldPressed += onMicrophoneHold;
            _hotkeyService.OnMicrophoneHoldCancelled += onMicrophoneHoldCancelled;
