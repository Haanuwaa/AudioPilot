...
public static class AppMenuGlyphs
{
    ...
    public static Geometry MoveUp { get; } = Create("M3,7 L8,2 L13,7 M8,2 V14");
    public static Geometry MoveDown { get; } = Create("M3,9 L8,14 L13,9 M8,2 V14");
    public static Geometry OutputMuted { get; } = Create("M1.5,6 H4.5 L8,2.5 V13.5 L4.5,10 H1.5 Z M10,5 L15,11 M15,5 L10,11");
    public static Geometry InputMuted { get; } = Create("M8,1.5 C6.3,1.5 5,2.8 5,4.5 V8 C5,9.7 6.3,11 8,11 C9.7,11 11,9.7 11,8 V4.5 C11,2.8 9.7,1.5 8,1.5 Z M3,8 C3,11 5,13 8,13 C11,13 13,11 13,8 M8,13 V15 M5,15 H11 M1,1 L15,15");
    public static Geometry Pause { get; } = Create("M4,2 V14 M12,2 V14");
    public static Geometry Next { get; } = Create("M2,2 L11,8 L2,14 Z M13,2 V14");
    public static Geometry Previous { get; } = Create("M14,2 L5,8 L14,14 Z M3,2 V14");
    public static Geometry SeekForward { get; } = Create("M1,3 L7,8 L1,13 Z M9,3 L15,8 L9,13 Z");
    public static Geometry SeekBackward { get; } = Create("M15,3 L9,8 L15,13 Z M7,3 L1,8 L7,13 Z");
    public static Geometry Information { get; } = Create("M8,1 A7,7 0 1 1 8,15 A7,7 0 1 1 8,1 M8,7 V12 M8,4 V5");
    public static Geometry Warning { get; } = Create("M8,1 L15,14 H1 Z M8,5 V9 M8,11 V12");
    public static Geometry Media { get; } = Create("M6,11 V3 L13,1 V9 M6,11 A2,2 0 1 1 2,11 A2,2 0 1 1 6,11 M13,9 A2,2 0 1 1 9,9 A2,2 0 1 1 13,9");
