...
namespace AudioPilot
{
    ...
    public partial class MainWindow : Window
    {
        ...
        internal MainWindow(MainWindowDependencies dependencies)
        {
            ...
            // WPF first enumerates system fonts during text measurement. Overlap that process-wide
            // initialization with XAML loading, using only a worker-local Typeface (no UI objects).
        ...
        private static void PrewarmFont(string fontFamily)
        {
            ...
            {
                // Font warmup is optional; normal WPF text rendering remains the fallback.
