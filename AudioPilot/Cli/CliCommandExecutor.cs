        ...
        public static async Task<CliExecutionResult> ExecuteAsync(CliCommand command, ICliCommandRuntime runtime)
        {
            ...
            try
            {
                return command.Action switch
                {
                    ...
                    CliAction.MediaPlayPause or CliAction.MediaNextTrack or CliAction.MediaPreviousTrack or CliAction.MediaStatus or CliAction.MediaSeek => await ExecuteMediaCommandAsync(command, runtime),
