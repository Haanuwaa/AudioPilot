...
namespace AudioPilot
{
    public partial class App : Application
    {
            ...
            IAppMainWindowManager windowManager) : ICliCommandRuntime
        {
            ...
            public Task<MediaSeekResult> MediaSeekAsync(bool backward, int? seconds) => InvokeOnUiAsync(() => _appVm.MediaSeekFromCliAsync(backward, seconds));
            public Task<MediaPlaybackResult> MediaSetPlayingAsync(bool playing) => _appVm.MediaSetPlayingFromCliAsync(playing);
