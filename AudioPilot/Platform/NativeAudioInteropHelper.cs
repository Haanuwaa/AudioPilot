...
namespace AudioPilot.Platform
{
    ...
    internal interface INativeAudioEndpointFactory
    {
        ...
        /// <summary>Opens an independently owned native endpoint without taking ownership of an existing device wrapper.</summary>
        bool TryCreate(string endpointId, [NotNullWhen(true)] out INativeAudioEndpoint? endpoint);
    }
    ...
    internal static partial class NativeAudioInteropHelper
    {
        ...
        private sealed class NativeAudioEndpointFactory(INativeComActivator activator) : INativeAudioEndpointFactory
        {
            ...
            public bool TryCreate(string endpointId, [NotNullWhen(true)] out INativeAudioEndpoint? endpoint)
            {
                ...
                try
                {
                    int getDeviceHr = enumeratorObject.Interface.GetDevice(endpointId, out IntPtr endpointPointer);
