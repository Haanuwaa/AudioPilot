...
namespace AudioPilot.Models
{
    ...
    public sealed class AudioRoutine : INotifyPropertyChanged, IJsonOnDeserializing, IJsonOnDeserialized
    {
        ...
        public RoutineTriggerKind TriggerKind
        {
            ...
            set
            {
                ...
                if (!_isDeserializing && _triggerKind is not RoutineTriggerKind.Application and not RoutineTriggerKind.SteamBigPicture)
                {
        ...
        void IJsonOnDeserialized.OnDeserialized()
        {
            ...
            NormalizeTriggerDependentState();
            ApplicationTriggerTitlePattern = _applicationTriggerTitlePattern;
            ...
            NetworkTriggerDirection = _networkTriggerDirection;
        }
        ...
        public bool SwitchOutputPerApp
        {
            ...
            set
            {
                bool normalized = value && (_isDeserializing || TriggerKind == RoutineTriggerKind.Application);
        ...
        public ApplicationTriggerMode ApplicationTriggerMode
        {
            ...
            set
            {
                ...
                if (!_isDeserializing && _triggerKind == RoutineTriggerKind.Application && value != ApplicationTriggerMode.ProcessFocus)
                {
                    if (!string.IsNullOrWhiteSpace(_applicationTriggerTitlePattern))
                    {
                        _applicationTriggerTitlePattern = string.Empty;
        ...
        public string ApplicationTriggerTitlePattern
        {
            ...
            set
            {
                string normalized = _isDeserializing || (_triggerKind == RoutineTriggerKind.Application && _applicationTriggerMode == ApplicationTriggerMode.ProcessFocus)
        ...
        public ApplicationTriggerTitleMatchMode ApplicationTriggerTitleMatchMode
        {
            ...
            set
            {
                ApplicationTriggerTitleMatchMode normalized = _isDeserializing || (_triggerKind == RoutineTriggerKind.Application && _applicationTriggerMode == ApplicationTriggerMode.ProcessFocus)
                    ? value
        ...
        public bool RestorePreviousAudioOnDeactivate
        {
            ...
            set
            {
                bool normalized = value && (_isDeserializing || IsStatefulTrigger);
        ...
        public bool ShowInTrayMenu
        {
            ...
            set
            {
                bool normalized = (_isDeserializing || TriggerKind == RoutineTriggerKind.Hotkey) && value;
        ...
        public bool NotifyBeforeScheduledRun
        {
            ...
            set => SetField(ref _notifyBeforeScheduledRun, value);
        }
        ...
        public HashSet<DayOfWeek> ScheduleDays
        {
            ...
            set
            {
                ...
                if (_scheduleDays.SetEquals(normalized))
                {
                    return;
                }

                _scheduleDays = normalized;
                OnTriggerSummariesChanged();
            }
        }
        ...
        public string ScheduleTimeZoneId
        {
            ...
            set
            {
                ...
                if (string.Equals(_scheduleTimeZoneId, normalized, StringComparison.Ordinal))
                {
                    return;
                }

                _scheduleTimeZoneId = normalized;
                OnTriggerSummariesChanged();
            }
        }
        ...
        public AudioRoutine Clone()
        {
            return new AudioRoutine
            {
                ...
                NotifyBeforeScheduledRun = HasScheduledTrigger && NotifyBeforeScheduledRun,
