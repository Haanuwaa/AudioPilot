...
namespace AudioPilot.Coordinators
{
    ...
    internal readonly record struct ApplySettingsBuildInput(
        ...
        bool UseScheduledStartup = false,
        bool CheckForUpdates = false,
        string SeekForwardHotkey = "",
        string SeekBackwardHotkey = "",
        int SeekStepSeconds = MediaSeekStep.DefaultSeconds,
        string ShowAudioStatusHotkey = "",
        string ForegroundVolumeUpHotkey = "",
        string ForegroundVolumeDownHotkey = "",
        string ForegroundMuteHotkey = "",
        string PushToTalkHotkey = "",
        string HoldToMuteHotkey = "",
        int ForegroundVolumeStepPercent = 5,
    ...
    internal static class AppSettingsWorkflowCoordinator
    {
        ...
        internal static Settings BuildAppliedSettings(Settings? cachedSettings, ApplySettingsBuildInput input)
        {
            ...
            newSettings.Miscellaneous.UseScheduledStartup = input.UseScheduledStartup;
            newSettings.Miscellaneous.CheckForUpdates = input.CheckForUpdates;
            newSettings.Miscellaneous.PlayAppSounds = input.PlayAppSounds;
            ...
            newSettings.Hotkeys.App.ToggleAppVisibility = input.ToggleAppVisibilityHotkey;
            newSettings.Hotkeys.App.ShowAudioStatus = input.ShowAudioStatusHotkey;
            ...
            newSettings.Hotkeys.Media.SeekForward = input.SeekForwardHotkey;
            newSettings.Hotkeys.Media.SeekBackward = input.SeekBackwardHotkey;
            newSettings.Hotkeys.Media.SeekStepSeconds = input.SeekStepSeconds;
            ...
            newSettings.Hotkeys.Volume.ForegroundUp = input.ForegroundVolumeUpHotkey;
            newSettings.Hotkeys.Volume.ForegroundDown = input.ForegroundVolumeDownHotkey;
            newSettings.Hotkeys.Volume.ForegroundMute = input.ForegroundMuteHotkey;
            newSettings.Hotkeys.Mute.PushToTalk = input.PushToTalkHotkey;
            newSettings.Hotkeys.Mute.PushToTalkEnabled = input.PushToTalkEnabled;
            newSettings.Hotkeys.Mute.HoldToMute = input.HoldToMuteHotkey;
            newSettings.Hotkeys.Volume.ForegroundVolumeStepPercent = input.ForegroundVolumeStepPercent;
            ...
            newSettings.DeviceSwitching.PreserveAudioLevels = input.PreserveAudioLevels;
            newSettings.DeviceSwitching.BluetoothReconnectEnabled = input.BluetoothReconnectEnabled;
        ...
        internal static List<string> BuildResetSummary(bool hasDevicesSelected, bool hasRoutines, bool hasHotkey, bool hasStartup, bool settingsFileExists)
        {
            ...
            if (hasHotkey)
            {
                summary.Add("- Clear custom device-switching hotkeys");
            }

            if (hasStartup)
            {
                summary.Add("- Turn off starting AudioPilot with Windows");
            }
