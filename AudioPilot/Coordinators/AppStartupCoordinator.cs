...
namespace AudioPilot.Coordinators
{
    ...
    {
        bool RegisterToggleAppVisibilityHotkey(string? hotkey, IEnumerable<string>? additionalStandaloneHotkeyKeys = null);
        bool RegisterShowAudioStatusHotkey(string? hotkey, IEnumerable<string>? additionalStandaloneHotkeyKeys = null);
        bool RegisterMediaHotkeys(string? showCurrent, string? playPause, string? nextTrack, string? previousTrack, IEnumerable<string>? additionalStandaloneHotkeyKeys = null, string? seekForward = null, string? seekBackward = null);
    ...
    public sealed class AppStartupCoordinator
    {
        ...
        private sealed class HotkeyServiceAdapter(HotkeyService hotkeyService) : IStartupHotkeyRegistrar, IStartupHotkeyRegistrationLoggingScope
        {
            ...
            public bool RegisterToggleAppVisibilityHotkey(string? hotkey, IEnumerable<string>? additionalStandaloneHotkeyKeys = null) => _hotkeyService.RegisterToggleAppVisibilityHotkey(hotkey, additionalStandaloneHotkeyKeys);
            public bool RegisterShowAudioStatusHotkey(string? hotkey, IEnumerable<string>? additionalStandaloneHotkeyKeys = null) => _hotkeyService.RegisterShowAudioStatusHotkey(hotkey, additionalStandaloneHotkeyKeys);
            public bool RegisterMediaHotkeys(string? showCurrent, string? playPause, string? nextTrack, string? previousTrack, IEnumerable<string>? additionalStandaloneHotkeyKeys = null, string? seekForward = null, string? seekBackward = null) => _hotkeyService.RegisterMediaHotkeys(showCurrent, playPause, nextTrack, previousTrack, additionalStandaloneHotkeyKeys, seekForward, seekBackward);
        ...
        private void RegisterHotkeys(Settings settings, string startupOpId)
        {
            ...
            bool toggleAppVisibilityRegistered = _hotkeyService.RegisterToggleAppVisibilityHotkey(settings.Hotkeys.App.ToggleAppVisibility, additionalStandaloneHotkeyKeys);
            bool showAudioStatusRegistered = _hotkeyService.RegisterShowAudioStatusHotkey(settings.Hotkeys.App.ShowAudioStatus, additionalStandaloneHotkeyKeys);
            bool mediaRegistered = _hotkeyService.RegisterMediaHotkeys(settings.Hotkeys.Media.ShowCurrentTrack, settings.Hotkeys.Media.PlayPause, settings.Hotkeys.Media.NextTrack, settings.Hotkeys.Media.PreviousTrack, additionalStandaloneHotkeyKeys, settings.Hotkeys.Media.SeekForward, settings.Hotkeys.Media.SeekBackward);
