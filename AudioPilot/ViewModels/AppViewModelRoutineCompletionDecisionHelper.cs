...
internal static class AppViewModelRoutineCompletionDecisionHelper
{
    ...
    {
        RoutineExecutionResult initialResult = BuildResult(
        ...
        RoutineExecutionResult successResult = BuildSuccessResult(
            appliedOutputDeviceName,
            appliedInputDeviceName,
            awaitingAppCompletion,
            appOutputApplied,
    ...
    private static RoutineExecutionResult BuildResult(
    ...
    private static RoutineExecutionResult BuildSuccessResult(
        string? outputDeviceName,
        string? inputDeviceName,
