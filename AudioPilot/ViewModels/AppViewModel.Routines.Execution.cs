    ...
    public partial class AppViewModel
    {
        ...
        private async Task<RoutineDeviceSwitchExecutionResult> ExecuteRoutineDirectOutputSwitchAsync(AudioRoutine routine, int? applicationProcessId)
        {
            ...
            try
            {
                ...
                AppViewModelRoutineSwitchGuardHelper.SwitchDecision outputSwitchDecision = AppViewModelRoutineSwitchGuardHelper.Evaluate(
                    currentDefault?.ID,
                    currentDefault?.FriendlyName,
                    routine.OutputDeviceId,
                    isOutput: true);

                if (outputSwitchDecision.Kind == AppViewModelRoutineSwitchGuardHelper.SwitchDecisionKind.MissingDefaultDevice)
                {
                    _logger.Warning(
                        "AppViewModel",
                ...
                if (outputSwitchDecision.Kind == AppViewModelRoutineSwitchGuardHelper.SwitchDecisionKind.AlreadyTarget)
                {
                    _logger.Debug(
                        "AppViewModel",
        ...
        private async Task<RoutineDeviceSwitchExecutionResult> ExecuteRoutineDirectInputSwitchAsync(AudioRoutine routine, int? applicationProcessId)
        {
            ...
            try
            {
                ...
                AppViewModelRoutineSwitchGuardHelper.SwitchDecision inputSwitchDecision = AppViewModelRoutineSwitchGuardHelper.Evaluate(
                    currentDefault?.ID,
                    currentDefault?.FriendlyName,
                    routine.InputDeviceId,
                    isOutput: false);
                ...
                if (inputSwitchDecision.Kind == AppViewModelRoutineSwitchGuardHelper.SwitchDecisionKind.MissingDefaultDevice)
                {
                    _logger.Debug(
                        "AppViewModel",
                ...
                if (inputSwitchDecision.Kind == AppViewModelRoutineSwitchGuardHelper.SwitchDecisionKind.AlreadyTarget)
                {
                    _logger.Debug(
                        "AppViewModel",
