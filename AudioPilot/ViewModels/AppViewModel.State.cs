...
namespace AudioPilot.ViewModels
{
    public partial class AppViewModel
    {
        ...
        private bool _settingsPlayAppSoundsDraft = true;
        private bool _settingsRunAtStartupDraft;
        private bool _settingsUseScheduledStartupDraft;
        private bool _settingsCheckForUpdatesDraft;
        ...
        private string _settingsSeekStepSecondsDraft = "10s";
        private string _settingsMicVolumeStepPercentDraft = "5";
        private string _settingsForegroundVolumeStepPercentDraft = "5";
        ...
        private bool _settingsSeekControlsExpanded;
        private bool _settingsMasterVolumeControlsExpanded;
        private bool _settingsMicVolumeControlsExpanded;
        private bool _settingsForegroundVolumeControlsExpanded;
        private bool _settingsMicrophoneHoldControlsExpanded;
        ...
        public bool IsResettingSettings
        {
            ...
            private set
            {
                if (_isResettingSettings == value) return;
                _isResettingSettings = value;
                OnPropertyChanged(nameof(IsResettingSettings));
            }
        }
        ...
        internal event Action<bool>? MicrophoneMuteChangeRequested;
        internal event Action<bool>? PushToTalkModeChanged;

        private bool _settingsPushToTalkEnabledDraft;
        public bool SettingsPushToTalkEnabledDraft
        {
            get => _settingsPushToTalkEnabledDraft;
            set
            {
                if (_settingsPushToTalkEnabledDraft == value) return;
                _settingsPushToTalkEnabledDraft = value;
                OnPropertyChanged(nameof(SettingsPushToTalkEnabledDraft));
            }
        }
        ...
        public bool Deafen
        {
            ...
            set
            {
                ...
                MicrophoneMuteChangeRequested?.Invoke(plan.DeviceMuteMicrophone);
        ...
        public bool SettingsCheckForUpdatesDraft
        {
            get => _settingsCheckForUpdatesDraft;
            set
            {
                if (_settingsCheckForUpdatesDraft == value) return;
                _settingsCheckForUpdatesDraft = value;
                OnPropertyChanged(nameof(SettingsCheckForUpdatesDraft));
            }
        }

        public bool SettingsUseScheduledStartupDraft
        {
            get => _settingsUseScheduledStartupDraft;
            set
            {
                if (_settingsUseScheduledStartupDraft == value) return;
                _settingsUseScheduledStartupDraft = value;
                OnPropertyChanged(nameof(SettingsUseScheduledStartupDraft));
            }
        }
        ...
        public bool SettingsPlayAppSoundsDraft
        {
            get => _settingsPlayAppSoundsDraft;
            set
            {
                if (_settingsPlayAppSoundsDraft == value)
                {
                    return;
                }

                _settingsPlayAppSoundsDraft = value;
                _dialogs.SetSoundsEnabled(value);
                OnPropertyChanged(nameof(SettingsPlayAppSoundsDraft));
            }
        }
        ...
        public string SettingsShowAudioStatusHotkeyDraft
        {
            get => SettingsShowAudioStatusHotkeyDraftCapture.ToHotkeyString();
            set => SetSettingsHotkeyDraft(SettingsShowAudioStatusHotkeyDraftCapture, value, nameof(SettingsShowAudioStatusHotkeyDraft));
        }
        ...
        public string SettingsSeekForwardHotkeyDraft
        {
            get => SettingsSeekForwardHotkeyDraftCapture.ToHotkeyString();
            set => SetSettingsHotkeyDraft(SettingsSeekForwardHotkeyDraftCapture, value, nameof(SettingsSeekForwardHotkeyDraft));
        }

        public string SettingsSeekBackwardHotkeyDraft
        {
            get => SettingsSeekBackwardHotkeyDraftCapture.ToHotkeyString();
            set => SetSettingsHotkeyDraft(SettingsSeekBackwardHotkeyDraftCapture, value, nameof(SettingsSeekBackwardHotkeyDraft));
        }
        ...
        public string SettingsForegroundVolumeUpHotkeyDraft
        {
            get => SettingsForegroundVolumeUpHotkeyDraftCapture.ToHotkeyString();
            set => SetSettingsHotkeyDraft(SettingsForegroundVolumeUpHotkeyDraftCapture, value, nameof(SettingsForegroundVolumeUpHotkeyDraft));
        }

        public string SettingsForegroundVolumeDownHotkeyDraft
        {
            get => SettingsForegroundVolumeDownHotkeyDraftCapture.ToHotkeyString();
            set => SetSettingsHotkeyDraft(SettingsForegroundVolumeDownHotkeyDraftCapture, value, nameof(SettingsForegroundVolumeDownHotkeyDraft));
        }

        public string SettingsForegroundMuteHotkeyDraft
        {
            get => SettingsForegroundMuteHotkeyDraftCapture.ToHotkeyString();
            set => SetSettingsHotkeyDraft(SettingsForegroundMuteHotkeyDraftCapture, value, nameof(SettingsForegroundMuteHotkeyDraft));
        }

        public string SettingsPushToTalkHotkeyDraft
        {
            get => SettingsPushToTalkHotkeyDraftCapture.ToHotkeyString();
            set => SetSettingsHotkeyDraft(SettingsPushToTalkHotkeyDraftCapture, value, nameof(SettingsPushToTalkHotkeyDraft));
        }

        public string SettingsHoldToMuteHotkeyDraft
        {
            get => SettingsHoldToMuteHotkeyDraftCapture.ToHotkeyString();
            set => SetSettingsHotkeyDraft(SettingsHoldToMuteHotkeyDraftCapture, value, nameof(SettingsHoldToMuteHotkeyDraft));
        }
        ...
        public bool SettingsSeekControlsExpanded
        {
            get => _settingsSeekControlsExpanded;
            set
            {
                if (_settingsSeekControlsExpanded == value)
                {
                    return;
                }

                _settingsSeekControlsExpanded = value;
                OnPropertyChanged(nameof(SettingsSeekControlsExpanded));
            }
        }
        ...
        public bool SettingsForegroundVolumeControlsExpanded
        {
            get => _settingsForegroundVolumeControlsExpanded;
            set
            {
                if (_settingsForegroundVolumeControlsExpanded == value)
                {
                    return;
                }

                _settingsForegroundVolumeControlsExpanded = value;
                OnPropertyChanged(nameof(SettingsForegroundVolumeControlsExpanded));
            }
        }
        public bool SettingsMicrophoneHoldControlsExpanded
        {
            get => _settingsMicrophoneHoldControlsExpanded;
            set
            {
                if (_settingsMicrophoneHoldControlsExpanded == value)
                {
                    return;
                }

                _settingsMicrophoneHoldControlsExpanded = value;
                OnPropertyChanged(nameof(SettingsMicrophoneHoldControlsExpanded));
            }
        }

        public string SettingsSeekStepSecondsDraft
        {
            get => _settingsSeekStepSecondsDraft;
            set
            {
                string normalized = value ?? string.Empty;
                if (string.Equals(_settingsSeekStepSecondsDraft, normalized, StringComparison.Ordinal))
                    return;

                _settingsSeekStepSecondsDraft = normalized;
                OnPropertyChanged(nameof(SettingsSeekStepSecondsDraft));
            }
        }
        ...
        public string SettingsForegroundVolumeStepPercentDraft
        {
            get => _settingsForegroundVolumeStepPercentDraft;
            set
            {
                string normalized = value?.Trim() ?? string.Empty;
                if (string.Equals(_settingsForegroundVolumeStepPercentDraft, normalized, StringComparison.Ordinal))
                    return;

                _settingsForegroundVolumeStepPercentDraft = normalized;
                OnPropertyChanged(nameof(SettingsForegroundVolumeStepPercentDraft));
            }
        }
        ...
        public bool SettingsShowAudioStatusHotkeyHasConflict => SettingsShowAudioStatusHotkeyDraftCapture.HasWarning;
        ...
        public bool SettingsSeekForwardHotkeyHasConflict => SettingsSeekForwardHotkeyDraftCapture.HasWarning;
        public bool SettingsSeekBackwardHotkeyHasConflict => SettingsSeekBackwardHotkeyDraftCapture.HasWarning;
        ...
        public bool SettingsForegroundVolumeUpHotkeyHasConflict => SettingsForegroundVolumeUpHotkeyDraftCapture.HasWarning;
        public bool SettingsForegroundVolumeDownHotkeyHasConflict => SettingsForegroundVolumeDownHotkeyDraftCapture.HasWarning;
        public bool SettingsForegroundMuteHotkeyHasConflict => SettingsForegroundMuteHotkeyDraftCapture.HasWarning;
        public bool SettingsPushToTalkHotkeyHasConflict => SettingsPushToTalkHotkeyDraftCapture.HasWarning;
        public bool SettingsHoldToMuteHotkeyHasConflict => SettingsHoldToMuteHotkeyDraftCapture.HasWarning;
        ...
        public ICommand ReorderOutputCycleDevicesCommand { get; }
        ...
        public ICommand ReorderInputCycleDevicesCommand { get; }
        ...
        public ICommand ReorderRoutinesCommand { get; }
