...
namespace AudioPilot.ViewModels
{
    ...
    {
        public IReadOnlyList<AudioRoutine> GetRoutinesSnapshotForCli()
        {
        ...
        public Task<CliExecutionResult> RunRoutineFromCliAsync(string selector, bool jsonOutput, bool redactOutput = false)
        {
            ...
            var coordinator = new CliRoutineCommandCoordinator(
                ...
                (routine, processId) => ExecuteRoutineForResolvedProcessAsync(routine, processId ?? 0, showOverlay: true, executionSource: "cli", cancellationToken: ShutdownToken, trackLifetime: false),
