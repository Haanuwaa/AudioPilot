            ...
            try
            {
                if (_audioOverrides?.GetDefaultPlaybackDeviceSnapshot != null)
                {
                    ...
                    (bool switchSucceeded, string? switchedDeviceName) = _audioOverrides.SwitchAudioDeviceAsync != null
                        ? _audioOverrides.SwitchAudioDeviceAsync(currentDeviceId, routine.OutputDeviceId, currentMuteMic, currentMuteSound, currentDeafen, settings.DeviceSwitching.PreserveAudioLevels, directOutputOpId)
                ...
                (bool success, string? deviceName) = _audioOverrides?.SwitchAudioDeviceAsync != null
                    ? _audioOverrides.SwitchAudioDeviceAsync(currentDefault.ID, routine.OutputDeviceId, muteMic, muteSound, deafen, settings.DeviceSwitching.PreserveAudioLevels, opId)
                    : await AudioService.SwitchAudioDeviceAsync(
                        currentDefault.ID,
                        routine.OutputDeviceId,
                        muteMic,
