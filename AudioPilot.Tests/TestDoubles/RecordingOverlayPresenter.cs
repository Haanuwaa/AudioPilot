...
internal sealed class RecordingOverlayPresenter : OverlayService.IOverlayPresenter
{
    ...
    public void SetIcon(OverlayIcon icon) => Icon = icon;
    ...
    public List<string?> ActionDetails { get; } = [];
    public List<(string header, string title, string? artist, string? detail)> MediaMessages { get; } = [];
    public List<AudioStatusSnapshot> AudioStatusSnapshots { get; } = [];

    public void UpdateAudioStatusContent(AudioStatusSnapshot snapshot) => AudioStatusSnapshots.Add(snapshot);
    ...
    public void UpdateContent(OverlayActionStateKind stateKind, string message, string? detail = null)
    {
        ActionUpdateCount++;
    ...
    public void UpdateContent(string header, string title, string? artist, string? detail = null)
    {
        ...
        MediaMessages.Add((header, title, artist, detail));
    }
