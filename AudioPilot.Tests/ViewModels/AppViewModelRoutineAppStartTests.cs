...
public sealed class AppViewModelRoutineAppStartTests
{
    ...
    public void EvaluateRoutineAppStartMatchesForProcess_MatchesExactPathProcess()
    {
        ...
        IReadOnlyList<RoutineAppStartMatch> result = RoutineApplicationRouting.EvaluateRoutineAppStartMatchesForProcess(watchedRoutines, snapshot);

        RoutineAppStartMatch matched = Assert.Single(result);
    ...
    {
        List<RoutineAppStartMatch> matches =
        [
            new(
                new AudioRoutine
                {
        ...
        bool result = RoutineApplicationRouting.ShouldCaptureProcessSnapshotsForStartedMatches(matches, activeLeaseCount: 1);
    ...
    public void ShouldCaptureProcessSnapshotsForStartedMatches_ReturnsFalse_WhenPerAppRoutingMatchesExistButNoActiveLeases()
    {
        ...
        bool result = RoutineApplicationRouting.ShouldCaptureProcessSnapshotsForStartedMatches(matches, activeLeaseCount: 0);
    ...
    public void ShouldCaptureProcessSnapshotsForStoppedProcess_ReturnsExpectedValue(
        ...
        bool expected)
    {
        bool result = RoutineApplicationRouting.ShouldCaptureProcessSnapshotsForStoppedProcess(activeLeaseCount, activeAppStartStatefulSessionCount);
    ...
    public void CollectRoutineAppOutputCandidateProcessIds_IncludesExactPathDescendantsAndSessionProcesses()
    {
        ...
        IReadOnlyList<uint> result = RoutineApplicationRouting.CollectRoutineAppOutputCandidateProcessIds(
            100,
    ...
    public void FindRunningRoutineTriggerProcessId_ReturnsLowestMatchingProcessId()
    {
        ...
        int? result = RoutineApplicationRouting.FindRunningRoutineTriggerProcessId(routine, snapshots);
    ...
    public void FindRunningProcessIdsForTriggerTarget_ReturnsMatchingPackagedAppProcessIdsInOrder()
    {
        ...
        IReadOnlyList<int> result = RoutineApplicationRouting.FindRunningProcessIdsForTriggerTarget(
            "SpotifyAB.SpotifyMusic_zpdnekdrzrea0!Spotify",
            snapshots);
    ...
    [Fact]
    public void GetSteamBigPictureWindowHandles_FindsWindow_WhenSteamWindowTitleAndClassMatchBigPicture()
    {
        List<RoutineProcessSnapshot> snapshots =
        [
    ...
    [Fact]
    public void GetSteamBigPictureWindowHandles_RejectsWindow_WhenBigPictureTitleUsesUnexpectedClass()
    {
        List<RoutineProcessSnapshot> snapshots =
        [
            new(120, @"C:\Program Files (x86)\Steam\steam.exe", 1),
        ...
        IReadOnlyList<AudioDeviceHelper.VisibleWindowHandleMetadata> visibleWindows =
        [
            new((nint)10, 140, "A Big Picture announcement", "Chrome_WidgetWin_1"),
        ];
    ...
    [Fact]
    public void GetSteamBigPictureWindowHandles_FindsWindow_WhenSteamHelperWindowMatchesSteamFallbackSignature()
    {
        List<RoutineProcessSnapshot> snapshots =
        [
    ...
    [Fact]
    public void GetSteamBigPictureWindowHandles_RejectsWindow_WhenRootSteamWindowOnlyMatchesLegacyFallbackSignature()
    {
        List<RoutineProcessSnapshot> snapshots =
        [
            new(120, @"C:\Program Files (x86)\Steam\steam.exe", 1),
    ...
    [Fact]
    public void GetSteamBigPictureWindowHandles_FindsWindow_WhenSteamWindowMatchesSpFallbackSignature()
    {
        List<RoutineProcessSnapshot> snapshots =
        [
            new(120, @"C:\Program Files (x86)\Steam\steamui.exe", 1),
    ...
    [Fact]
    public void GetSteamBigPictureWindowHandles_ToleratesDuplicateProcessSnapshots()
    {
        List<RoutineProcessSnapshot> snapshots =
        [
            new(140, @"C:\Program Files (x86)\Steam\steamwebhelper.exe", 120),
    ...
    [Fact]
    public void GetSteamBigPictureWindowHandles_RejectsWindow_WhenMatchingWindowBelongsToNonSteamProcess()
    {
        List<RoutineProcessSnapshot> snapshots =
        [
        ...
        IReadOnlyList<AudioDeviceHelper.VisibleWindowHandleMetadata> visibleWindows =
        [
            new((nint)10, 120, "Steam Big Picture Mode", "SDL_app"),
        ];
    ...
    [Fact]
    public void GetSteamBigPictureWindowHandles_EmitsTraceDiagnostics_WhenSteamWindowIsRejected()
    {
        List<RoutineProcessSnapshot> snapshots =
        [
            new(120, @"C:\Program Files (x86)\Steam\steam.exe", 1),
        ...
        IReadOnlyList<AudioDeviceHelper.VisibleWindowHandleMetadata> visibleWindows =
        [
            new((nint)10, 120, "Steam", "Chrome_WidgetWin_1"),
        ];

        IReadOnlyList<nint> result = AppViewModel.GetSteamBigPictureWindowHandles(snapshots, visibleWindows, traces.Add);
    ...
    public async Task DeactivateRoutineStatefulSessionAsync_RemovesOlderSessionWithoutAffectingLatest()
    {
        ...
        activeSessions["application-launch:routine-old:100"] = new RoutineStatefulSession(
            ...
            rootProcessId: 100);
        activeSessions["application-launch:routine-new:200"] = new RoutineStatefulSession(
    ...
    public async Task DeactivateRoutineStatefulSessionAsync_RemovesLatestSession_WhenRestoreSnapshotIsMissing()
    {
        ...
        AppViewModel viewModel = harness.ViewModel;
        var activeSessions = GetActiveRoutineStatefulSessions(viewModel);
        activeSessions["steam-big-picture:routine-steam"] = new RoutineStatefulSession(
    ...
    public async Task DeactivateRoutineStatefulSessionAsync_ClearsWaitingForAppAudio_WhenAppExitsBeforeAudioAppears()
    {
        await SharedStaDispatcherHost.RunAsync(async () =>
        {
            ...
            var activeSessions = GetActiveRoutineStatefulSessions(viewModel);
            activeSessions["application-launch:routine-1:100"] = new RoutineStatefulSession(
    ...
    public async Task DeactivateRoutineStatefulSessionAsync_KeepsWaitingForAppAudio_WhenAnotherSameRoutineSessionRemains()
    {
        await SharedStaDispatcherHost.RunAsync(async () =>
        {
            ...
            activeSessions["application-launch:routine-1:100"] = new RoutineStatefulSession(
                ...
                restoreSnapshot: null,
                rootProcessId: 100);
            activeSessions["application-launch:routine-1:200"] = new RoutineStatefulSession(
    ...
    public void CompletePendingAppAudioWaitForRemovedLeases_KeepsWaiting_WhenAnotherLeaseForRoutineRemains()
    {
        ...
        viewModel.SetRoutineLastRunStateForTests("routine-1", RoutineLastRunState.WaitingForApp);
        viewModel.GetActiveRoutineAppOutputLeasesForTests()["routine-1:200"] = new RoutineAppOutputLease(
            "routine-1:200",
            "routine-1",
            "Discord",
            200,
    ...
    public void RegisterRoutineAppOutputLease_WhenSameProcessRerunsDeferred_ClearsCompletedOutputState()
    {
        ...
        Dictionary<string, RoutineAppOutputLease> activeLeases = viewModel.GetActiveRoutineAppOutputLeasesForTests();
        var lease = new RoutineAppOutputLease(
            "routine-1:28776",
            "routine-1",
            "Discord",
            28776,
        ...
        RoutineAppOutputLease updatedLease = Assert.Single(activeLeases.Values);
    ...
    public void UpdateRoutineAppStartMonitorState_AcquiresSessionMonitoring_ForPendingLeaseTargets()
    {
        ...
        AppViewModel viewModel = harness.ViewModel;
        Dictionary<string, RoutineAppOutputLease> activeLeases = viewModel.GetActiveRoutineAppOutputLeasesForTests();
        activeLeases["routine-1:100"] = new RoutineAppOutputLease(
            "routine-1:100",
            "routine-1",
            "Spotify",
            100,
    ...
    public void MarkRoutineAppOutputLeaseCompleted_PromotesWaitingRoutineToSucceeded()
    {
        ...
        var lease = new RoutineAppOutputLease("routine-1:100", "routine-1", "Spotify", 100,
            @"C:\Apps\Spotify\Spotify.exe", "out-1", "Speakers");
        viewModel.GetActiveRoutineAppOutputLeasesForTests()[lease.LeaseKey] = lease;
        viewModel.MarkRoutineAppOutputLeaseCompletedForTests(lease.Clone());
    ...
    {
        Dictionary<string, RoutineAppOutputLease> currentLeases = new(StringComparer.OrdinalIgnoreCase)
        {
        ...
        Dictionary<string, RoutineAppOutputLease> result = RoutineApplicationRouting.ReconcileRoutineAppOutputLeases(currentLeases, watchedRoutines, snapshots);
    ...
    {
        var lease = new RoutineAppOutputLease("routine-1:100", "routine-1", "Spotify", 100, @"C:\Apps\Spotify\Spotify.exe", "out-1", "Speakers");
        lease.AppliedOutputProcessIds.Add(100u);
        ...
        RoutineAppOutputLease updatedLease = Assert.Single(result.Values);
    ...
    {
        DateTime nowUtc = new(2026, 6, 28, 12, 0, 0, DateTimeKind.Utc);
        var lease = new RoutineAppOutputLease("routine-1:100", "routine-1", "Discord", 100, @"C:\Apps\Discord\Discord.exe", "out-1", "Speakers")
        {
            CreatedUtc = nowUtc,
        };
        Dictionary<string, RoutineAppOutputLease> currentLeases = new(StringComparer.OrdinalIgnoreCase)
        ...
        Dictionary<string, RoutineAppOutputLease> result = RoutineApplicationRouting.ReconcileRoutineAppOutputLeases(currentLeases, watchedRoutines, snapshots, nowUtc);

        RoutineAppOutputLease retainedLease = Assert.Single(result.Values);
    ...
    public void ReconcileRoutineAppOutputLeases_RemovesOldPendingLease_WhenRootSnapshotIsMissing()
    {
        ...
        var lease = new RoutineAppOutputLease("routine-1:100", "routine-1", "Discord", 100, @"C:\Apps\Discord\Discord.exe", "out-1", "Speakers")
        {
            CreatedUtc = nowUtc - TimeSpan.FromSeconds(10),
        };
        Dictionary<string, RoutineAppOutputLease> currentLeases = new(StringComparer.OrdinalIgnoreCase)
        {
            [lease.LeaseKey] = lease
    ...
    {
        var firstLease = new RoutineAppOutputLease("routine-1:100", "routine-1", "Spotify", 100, @"C:\Apps\Spotify\Spotify.exe", "out-1", "Speakers");
        var secondLease = new RoutineAppOutputLease("routine-1:200", "routine-1", "Spotify", 200, @"C:\Apps\Spotify\Spotify.exe", "out-1", "Speakers");
    ...
    public void SynchronizeRoutineAppOutputLeasesWithWatchedRoutines_KeepsInputOnlyLease()
    {
        ...
        Dictionary<string, RoutineAppOutputLease> result = RoutineApplicationRouting.SynchronizeRoutineAppOutputLeasesWithWatchedRoutines(currentLeases, watchedRoutines);
    ...
    public void IsRoutineAppOutputLeaseAlive_ReturnsFalse_WhenOnlyUnrelatedSamePathProcessRemains()
    {
        ...
        bool alive = RoutineApplicationRouting.IsRoutineAppOutputLeaseAlive(100, @"C:\Apps\Spotify\Spotify.exe", snapshots);
    ...
    public void IsRoutineAppOutputLeaseAlive_ReturnsTrue_WhenPackagedRootAndDescendantRemain()
    {
        ...
        bool alive = RoutineApplicationRouting.IsRoutineAppOutputLeaseAlive(100, "SpotifyAB.SpotifyMusic_zpdnekdrzrea0!Spotify", snapshots);
    ...
    public void CreateRoutineAppStartSnapshotSet_UsesLastSnapshotForDuplicatePid()
    {
        ...
        RoutineAppStartSnapshotSet snapshotSet = RoutineApplicationRouting.CreateRoutineAppStartSnapshotSet(snapshots);
    ...
    public void ShouldSkipRoutineAppStartMatchForExistingLease_ReturnsTrue_ForDescendantOfExistingLease()
    {
        ...
        RoutineAppStartMatch match = new(routine, 101);
        ...
        bool result = RoutineApplicationRouting.ShouldSkipRoutineAppStartMatchForExistingLease(match, processSnapshot, activeLeases, processSnapshots);
    ...
    public void ShouldSkipRoutineAppStartMatchForExistingLease_ReturnsFalse_ForSeparateRootOfSameRoutine()
    {
        ...
        RoutineAppStartMatch match = new(routine, 200);
    ...
    public void ShouldSkipRoutineAppStartMatchForExistingLease_ReturnsFalse_WhenLeaseRootPidWasReused()
    {
        ...
        RoutineAppStartMatch match = new(routine, 100);
    ...
    public void ShouldSkipRoutineAppStartMatchForExistingLease_ReturnsFalse_WhenNoActiveLeasesExist()
    {
        ...
        bool result = RoutineApplicationRouting.ShouldSkipRoutineAppStartMatchForExistingLease(match, processSnapshot, [], []);
    ...
    public void BuildRoutineStatefulSessionLogContext_IncludesRestoreDecision()
    {
        var session = new RoutineStatefulSession(
            ...
            restorePreviousAudioOnDeactivate: true,
            restoreSnapshot: new RoutineAudioRestoreSnapshot("out-1", "Desk Speakers", "in-1", "Desk Mic"),
            rootProcessId: 321);
    ...
    {
        var snapshot = new RoutineAudioRestoreSnapshot(
            "out-1",
            "Desk Speakers",
            "in-1",
            "Desk Mic");
    ...
    public void LogRoutineAppStartMatchSkipped_IncludesCorrelatedOperationId()
    {
        ...
        var match = new RoutineAppStartMatch(
            new AudioRoutine
            {
                Id = "routine-1",
                Name = "Desk",
    ...
    public async Task ApplyRoutineAppOutputLeasesAsync_WhenLiveLeasesAreAlreadyComplete_DoesNotAcquireSessionSnapshots()
    {
        ...
        RoutineAppOutputLease refreshedLease = Assert.Single(activeLeases.Values);
    ...
    private static Dictionary<string, RoutineStatefulSession> GetActiveRoutineStatefulSessions(AppViewModel viewModel)
    {
    ...
    {
        return viewModel.TryClaimRoutineAppStartMatchForTests(routineId, processSnapshot);
    }
