...
public sealed class AppViewModelCleanupTests
{
    ...
    public async Task CleanupAsync_DeactivatesActiveStatefulSessions()
    {
        ...
        Dictionary<string, RoutineStatefulSession> activeSessions = harness.ViewModel.GetActiveRoutineStatefulSessionsForTests();
        activeSessions["application-launch:routine-focus:321"] = new RoutineStatefulSession(
