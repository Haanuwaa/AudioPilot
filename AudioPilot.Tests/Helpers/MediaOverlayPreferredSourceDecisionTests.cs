...
public sealed class MediaOverlayPreferredSourceDecisionTests
{
    ...
    public void DescribePreferredSourceCandidateDiagnostics_IncludesVerdictAndReason()
    {
        ...
        string withoutReference = MediaOverlayPreferredSourceCandidateEvaluator.DescribeCandidateDiagnostics(null, candidate, null);
        Assert.Contains("reason=NoReferenceContext", withoutReference, StringComparison.Ordinal);
        Assert.Contains("browserLikeSource=True", withoutReference, StringComparison.Ordinal);
    }
