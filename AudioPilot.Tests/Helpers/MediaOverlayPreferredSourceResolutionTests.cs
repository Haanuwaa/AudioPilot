...
public sealed class MediaOverlayPreferredSourceResolutionTests
{
    ...
    public void IsPendingEventCorroborationCandidate_ReturnsTrue_ForSameSourceChangedPlayingTrackWithoutTimelineReset()
    {
        ...
        bool pending = MediaOverlayPreferredSourceCandidateEvaluator.EvaluateCandidateDecision(baseline, candidate).IsPending;
    ...
    public void ShouldRejectPreferredSourceCandidate_ReturnsTrue_ForPausedSiblingTabWithoutTransition()
    {
        ...
        bool rejected = !MediaOverlayPreferredSourceCandidateEvaluator.EvaluateCandidateDecision(baseline, pausedSiblingTab).IsAccepted;
    ...
    public void ShouldRejectPreferredSourceCandidate_ReturnsTrue_ForBrowserEarlyPositionCandidateUntilCorroborated()
    {
        ...
        bool rejected = !MediaOverlayPreferredSourceCandidateEvaluator.EvaluateCandidateDecision(baseline, earlyCandidate).IsAccepted;
    ...
    public void ShouldRejectPreferredSourceCandidate_ReturnsTrue_ForBrowserTimelineTransitionUntilCorroborated()
    {
        ...
        bool rejected = !MediaOverlayPreferredSourceCandidateEvaluator.EvaluateCandidateDecision(baseline, actualNextVideo).IsAccepted;
    ...
    public void ShouldRejectPreferredSourceCandidate_ReturnsTrue_ForPlayingSiblingTabNearStart_WhenReferenceAlsoNearStart()
    {
        ...
        bool rejected = !MediaOverlayPreferredSourceCandidateEvaluator.EvaluateCandidateDecision(baseline, siblingTab).IsAccepted;
    ...
    public void ShouldRejectPreferredSourceCandidate_ReturnsTrue_ForBrowserNearStartChangedTrack_WhenReferenceRemainsWithinBrowserWindow()
    {
        ...
        bool rejected = !MediaOverlayPreferredSourceCandidateEvaluator.EvaluateCandidateDecision(baseline, nextTrack).IsAccepted;
    ...
    public void ShouldRejectPreferredSourceCandidate_SingleVisibleCandidatePausedSibling_IsRejected()
    {
        ...
        bool rejected = !MediaOverlayPreferredSourceCandidateEvaluator.EvaluateCandidateDecision(baseline, onlyVisibleCandidate).IsAccepted;
    ...
    public void ShouldRejectPreferredSourceCandidate_ReturnsTrue_ForPausedBrowserNextVideoNearStart()
    {
        ...
        bool rejected = !MediaOverlayPreferredSourceCandidateEvaluator.EvaluateCandidateDecision(baseline, pausedNextVideo).IsAccepted;
    ...
    public void ShouldRejectPreferredSourceCandidate_ReturnsTrue_AtPausedCandidateStartWindowBoundary()
    {
        ...
        bool rejected = !MediaOverlayPreferredSourceCandidateEvaluator.EvaluateCandidateDecision(baseline, pausedNextVideoAtBoundary).IsAccepted;
