...
public sealed class MediaOverlayMessageFallbackTests
{
    ...
    [Fact]
    public void BuildOverlayMessage_NextTrackReportsMissingSession_WhenTheSessionRemainsUnavailableAfterRecovery()
    {
        var baseline = new MediaOverlaySessionSnapshot(
            GlobalSystemMediaTransportControlsSessionPlaybackStatus.Playing,
            Title: "Track A",
    ...
    public void BuildOverlayMessage_ShowsUnavailable_WhenNoMediaSessionContextExists(MediaOverlayCommand command)
    {
        MediaOverlayResult result = FormatTrackMessage(
            command,
            MediaOverlaySessionSnapshot.Empty,
